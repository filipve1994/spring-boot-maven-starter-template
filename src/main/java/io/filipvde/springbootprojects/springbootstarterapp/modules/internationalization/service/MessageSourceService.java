package org.fve.springbootprojects.springbootstarterapp.modules.internationalization.service;
...
public class MessageSourceService {
    ...
    private static final Logger log = LoggerFactory.getLogger(MessageSourceService.class);
